...
const Contact = () => {
  ...
  return (
    <>
      ...
      <main className="bg-[#F8F8F8] text-[#1F2933]" data-navbar-theme="light">
        <section className="px-6 pb-24 pt-32 md:pb-32 md:pt-40 lg:px-12">
          <div className="mx-auto max-w-7xl">
            <div className="max-w-[650px]">
              ...
              <h1 className="mt-8 max-w-[680px] text-5xl font-semibold leading-[0.98] tracking-[-0.06em] text-[#1F2933] md:text-[68px] lg:text-[66px]">
            ...
            <div className="mt-20 grid gap-16 lg:grid-cols-[minmax(0,1fr)_minmax(420px,0.9fr)] lg:items-start lg:gap-24">
              ...
              <div className="lg:pt-8">
                <h2 className="text-3xl font-semibold leading-[1.05] tracking-[-0.045em] text-[#1F2933] md:text-[36px]">Let&apos;s talk about your goals</h2>
                <p className="mt-4 text-[14px] text-[#62676B] md:text-[15px]">Free 30-min strategy call · No commitment</p>

                <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
                  <label className="sr-only" htmlFor="contact-name">Your name</label>
                  <input id="contact-name" name="name" required placeholder="Jane Smith" className="w-full border border-transparent bg-white px-4 py-4 text-[14px] text-[#1F2933] outline-none transition-colors placeholder:text-[#9A9A9A] focus:border-[#C9A227]" />

                  <label className="sr-only" htmlFor="contact-email">Your email</label>
                  <input id="contact-email" name="email" type="email" required placeholder="jane@company.com" className="w-full border border-transparent bg-white px-4 py-4 text-[14px] text-[#1F2933] outline-none transition-colors placeholder:text-[#9A9A9A] focus:border-[#C9A227]" />
                  ...
                  <textarea id="contact-message" name="message" required placeholder="Message..." rows={5} className="w-full resize-y border border-transparent bg-white px-4 py-4 text-[14px] text-[#1F2933] outline-none transition-colors placeholder:text-[#9A9A9A] focus:border-[#C9A227]" />

                  <button
                    type="submit"
                    className="w-full bg-[#C9A227] px-4 py-4 text-[14px] font-semibold text-white transition-colors hover:bg-[#1F2933]"
                    >
